...
export declare class Kraken {
  ...
  assets(options?: { asset?: string; aclass?: string }): Promise<Kraken.Assets>;
  assetPairs(options?: { pair?: string; info?: string }): Promise<Kraken.AssetPairs>;
  ticker(options: { pair: string }): Promise<Kraken.Ticker>;
  ohlc(options: { pair: string; interval?: number; since?: number }): Promise<Kraken.OHLC>;
  depth(options: { pair: string; count?: number }): Promise<Kraken.Depth>;
  trades(options: { pair: string; since?: string }): Promise<Kraken.Trades>;
  spread(options: { pair: string; since?: number }): Promise<Kraken.Spread>;
  getWebSocketsToken(): Promise<Kraken.GetWebSocketsToken>;
  balance(): Promise<Kraken.Balance>;
  tradeBalance(options?: { asset?: string }): Promise<Kraken.TradeBalance>;
  openOrders(options?: { trades?: boolean; userref?: number }): Promise<Kraken.OpenOrders>;
  ...
  queryTrades(options?: { txid?: string; trades?: boolean }): Promise<Kraken.QueryTrades>;
  ...
  queryLedgers(options?: { id?: string; trades?: boolean }): Promise<Kraken.QueryLedgers>;
  tradeVolume(options: { pair: string; "fee-info"?: boolean }): Promise<Kraken.TradeVolume>;
  addExport(options: {
    report: string;
    format?: string;
    description: string;
  ...
  exportStatus(options: { report: string }): Promise<Kraken.ExportStatus>;
  retrieveExport(options: { id: string }): Promise<Kraken.RetrieveExport>;
  removeExport(options: { id: string; type: string }): Promise<Kraken.RemoveExport>;
  addOrder(options: {
    userref?: number;
    ordertype: string;
    type: string;
  ...
  cancelOrder(options: { txid: string | number }): Promise<Kraken.CancelOrder>;
  cancelAll(): Promise<Kraken.CancelAll>;
  cancelAllOrdersAfter(options: { timeout: number }): Promise<Kraken.CancelAllOrdersAfter>;
  depositMethods(options: { asset: string }): Promise<Kraken.DepositMethods>;
  withdrawMethods(options?: {
    asset?: string;
    aclass?: string;
    network?: string;
  ...
  depositStatus(options: { asset: string; method?: string }): Promise<Kraken.DepositStatus>;
  withdrawInfo(options: {
    asset: string;
    key: string;
    amount: string;
  }): Promise<Kraken.WithdrawInfo>;
  withdraw(options: { asset: string; key: string; amount: string }): Promise<Kraken.Withdraw>;
  withdrawStatus(options: { asset: string; method?: string }): Promise<Kraken.WithdrawStatus>;
  withdrawCancel(options: { asset: string; refid: string }): Promise<Kraken.WithdrawCancel>;
  ...
  stake(options: { asset: string; amount: string; method: string }): Promise<Kraken.Stake>;
  unstake(options: { asset: string; amount: string }): Promise<Kraken.Unstake>;
  ...
  readonly ws: {
    ...
    ticker(): Kraken.WS.Subscriber<
      ...
      {}
    >;
    ohlc(options?: { interval?: number }): Kraken.WS.Subscriber<
      {
    ...
    spread(): Kraken.WS.Subscriber<
      ...
      {}
    >;
    book(options?: { depth?: number }): Kraken.WS.Subscriber<
      {
    ...
    >;
    ownTrades(options: { token: string; snapshot?: boolean }): Kraken.WS.Subscriber<
      {
    ...
    >;
    openOrders(options: { token: string; ratecounter?: boolean }): Kraken.WS.Subscriber<
      {
    ...
    cancelAll(options: { token: string; reqid?: number }): Promise<Kraken.WS.CancelAll>;
...
export declare module Kraken {
  ...
  type FirstParam<T extends (...args: any[]) => any> = Parameters<T> extends []
    ? void
    : Parameters<T>[0];
  type Time = {
  ...
  module WS {
    ...
    module Book {
      ...
      type LevelUpdate = [string, string, string, "r"?];
      type Snapshot = {
        as: Array<Level>;
        bs: Array<Level>;
      };
    ...
    class Connection extends Emitter<{
      ...
      ping(): Promise<void>;
      request(request: { event: string; reqid?: number }): Promise<any>;
      requestMulti(
        request: {
          event: string;
          reqid?: number;
...
export declare function _prepareRequest(
  endpoint: string,
  options: NodeJS.Dict<any> | null,
  type: "public" | "private",
  gennonce: () => number,
...
export declare function _sendRequest(
  requestOptions: http.RequestOptions,
  postdata: string | null,
  encoding: "utf8" | "binary",
  timeout: number
): Promise<unknown>;
export declare function _request(
  endpoint: string,
  options: NodeJS.Dict<any> | null,
  type: "public" | "private",
  encoding: "utf8" | "binary",
