...
exports._hidePrivates =
  exports._CountTrigger =
  exports._Legacy =
  exports._request =
  exports._sendRequest =
  exports._prepareRequest =
  exports._BinaryReceiver =
  exports._UTF8Receiver =
  exports._Authenticator =
  exports.Kraken =
  exports._GENNONCE =
  exports._REST_VERSION =
  exports._WS_PRIV_HOSTNAME =
  exports._WS_PUB_HOSTNAME =
  exports._REST_HOSTNAME =
  exports._USER_AGENT =
    void 0;
...
class Kraken {
  constructor({
    ...
    this.ws = new (class WS {
      ...
      cancelOrder(options) {
        return this.priv.requestMulti(
          Object.assign(Object.assign({}, options), { event: "cancelOrder" }),
          options.txid.length
        );
      }
      cancelAll(options) {
      ...
      cancelAllOrdersAfter(options) {
        return this.priv.request(
          Object.assign(Object.assign({}, options), { event: "cancelAllOrdersAfter" })
        );
      }
    })(this);
    if (key && !secret) {
  ...
  call(method, options, cb) {
    ...
    const onceresponse = new Promise((resolve, reject) =>
      __awaiter(this, void 0, void 0, function* () {
        try {
          const res = _Legacy.parseNested(
            yield this.request(method, options || null, type, "utf8"),
            this._legacy.parse
          );
    ...
    class Subscription extends ts_ev_1.Emitter {
      constructor(con, reqid, pair) {
        ...
        this._onstatus = (status) => {
          ...
          if (this.status.errorMessage) this.emit("error", new WSAPIError(this.status));
  ...
  if (type === "private") {
    ...
    const postdata = options
      ? new url_1.URLSearchParams(
          auth.signedQuery(Object.assign(Object.assign({}, options), { nonce }))
        ).toString()
    ...
    if (options) {
      ...
      const postdata = new url_1.URLSearchParams(
        Object.assign(Object.assign({}, options), { nonce })
      ).toString();
      return {
        requestOptions: {
          hostname,
      ...
      return new Promise((resolve, reject) =>
        __awaiter(this, void 0, void 0, function* () {
          try {
            ...
            if (data.error.length) reject(new Kraken.RESTAPIError(data));
            resolve(data.result);
          } catch (e) {
            reject(e);
          }
...
(function (_Legacy) {
  ...
  function parseNested(o, parse) {
    function rangedDate(data, back = 0.5, fwd = 0.5, exclude = {}) {
      ...
      const check = (target, back, fwd, exclude) =>
        isFinite(target) &&
  ...
  for (const [prop, descr] of Object.entries(Object.getOwnPropertyDescriptors(o))) {
    if (prop[0] === "_")
      Object.defineProperty(
        o,
        prop,
        Object.assign(Object.assign({}, descr), { enumerable: false })
      );
  }
}
